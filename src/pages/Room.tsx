...
export default function Room() {
  ...
  const { useSetIsSpectator } = playerActions()
  ...
  useEffect(() => {
    ...
    connection.on(ioEvents.changeType, (player) => console.log(player))
